# Eval calibration run `eval-20260601T084031Z`

Generated at (UTC): 2026-06-01T08:40:36.998266+00:00

## Configuration

- Ideas (1): `slack-hr-bot`
- Eval user_id (filter handle): `de6b95d8-a385-40e3-b8a3-33ad70b8ef73`
- Output directory: `D:/Fivvle/docs/calibration/runs/eval-20260601T084031Z`
...
| --- | --- | --- | --- | ---: | ---: | ---: | --- |
| slack-hr-bot | `e6ebe652-00e4-4777-8573-e997342d85a9` | `eval-slack-hr-bot-20260601T084031Z` | RESEARCH_FAILED | 4.9 | 0.0000 | — | planner:InstructorRetryException: <failed_attempts>  <generation number="1"> <exception>     Error code: 400 - {'erro... |
...
- **Mean latency per run:** 4.9s
- **P90 latency per run:** 4.9s
