...
async def generate_tags(
    ...
    try:
        ...
        token_count = meta.prompt_tokens + meta.completion_tokens
        if len(validated) < 2:
            _logger.warning(
        ...
        # No exc_info — Rich/traceback emit can raise UnicodeEncodeError on
        # cp1252 consoles and escape this soft-fail (wiping refine turns).
        try:
            _logger.warning(
