/** Shared brutalist class strings for marketing surfaces. */

export const marketingCardClass =
  "rounded-md border-2 border-border-master shadow-brutal-md transition-all motion-reduce:transition-none hover:shadow-brutal-lg hover:-translate-x-0.5 hover:-translate-y-0.5 motion-reduce:hover:translate-x-0 motion-reduce:hover:translate-y-0";
