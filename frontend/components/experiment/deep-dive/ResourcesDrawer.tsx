      ...
      {expanded ? (
        <form onSubmit={submit} className="space-y-2 border-b-2 border-border-master p-4">
          ...
          <button
            type="submit"
            disabled={saving}
            className="border-2 border-border-master bg-accent px-3 py-2 font-label-md text-label-sm uppercase text-ink-inverse"
          >
            Save
          </button>
        </form>
            ...
            <article key={r.id} className="border-2 border-border-master p-3">
              ...
              {r.url ? (
                <a
                  ...
                  className="mt-1 block break-all font-body-sm text-body-sm text-accent"
                >
                  {r.url}
                </a>
              ) : null}
